...
def add_gems
 ...
 gem  "dunnas_endereco", git: "https://#{ENV['BITBUCKET_NAME']}:#{ENV['BITBUCKET_PASSWORD']}@bitbucket.org/dunnas/dunnas_endereco.git"
 gem  "dunnas_admin", git: "https://#{ENV['BITBUCKET_NAME']}:#{ENV['BITBUCKET_PASSWORD']}@bitbucket.org/dunnas/dunnas_admin.git"
